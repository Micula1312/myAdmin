...
{id:'blivet',name:'BLIVET',category:'community',status:'intermittent',client:'BLIVET',budget:0,deadline:'',nextAction:'',notes:'',subprojects:[]},
{id:'aotu',name:'AOTU',category:'personal',status:'intermittent',client:'',budget:0,deadline:'',nextAction:'',notes:'The Archive of the Untamed',subprojects:[]},
{id:'myadmin',name:'myAdmin',category:'personal',status:'active',client:'',budget:0,deadline:'',nextAction:'Indicizzare i repo operativi',notes:'Software personale di amministrazione e lavoro.',subprojects:[{id:'myadmin-core',name:'Core software',status:'active',repoUrl:'https://github.com/Micula1312/myAdmin',localPath:'C:/Users/micol/repository/myADMIN',tasks:[{id:uid('t'),text:'Ridisegnare workspace progetti',status:'doing'}]}]}
];
